...
class caranet(nn.Module):
    def __init__(self, in_chans = 1, channel=32):
        super().__init__()
        
         # ---- ResNet Backbone ----
        self.resnet = timm.create_model('res2net101_26w_4s', pretrained=True)
        self.resnet.conv1 = nn.Conv2d(in_chans, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
